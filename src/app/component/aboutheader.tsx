...
const AboutH = () => {
    return (
        <div className=" w-[390] h-[54] md:w-[1440] bg-[rgb(42,37,75)]">
            <link
                rel="stylesheet"
            ...
            <div className="flex">
                ...
                <Link href="/" passHref><Image src="/photos/Close.png" alt="del" height={100} width={100} className=" absolute h-[16] w-[16] mt-[15] ml-[80] md:ml-[500] md:h-[24] md:w-[24]"></Image></Link>

            </div>
            <div className="h-[124] flex">
                <h1 className="ml-[24] mt-[20] font-clash text-2xl md:absolute md:ml-[28] md:mt-[62]">Avion</h1>
            </div>
            <div className=" hidden md:block absolute ml-[1047] mt-[-60]">
            ...
            <div className=" hidden md:flex ml-[1309] mt-[-60] gap-[16]">
            ...
            <div className=" h-[54] bg-gray-100 py-4 pl-6  mt-[-50]  w-[390]  overflow-hidden md:block md:w-[1440] md:mt-[50]">
            <ul className=" flex font-satoshi  gap-[44] text-gray-500 md:ml-[318] md:w-[1440]  w-[390]  whitespace-nowrap  overflow-hidden ">
