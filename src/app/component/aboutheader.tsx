    ...
    return (
        <div className="sm:w-[390] h-[54] md:w-[1440] bg-[rgb(42,37,75)]">
            ...
            <div className="flex">
                ...
                <Link href="/" passHref><Image src="/photos/Close.png" alt="del" height={100} width={100} className=" absolute h-[16] w-[16] mt-[15] ml-[350] md:ml-[500] md:h-[24] md:w-[24]"></Image></Link>
            ...
            <div className=" h-[54] w-[827] bg-gray-100 py-4 pl-6 overflow-hidden md:w-[1440] md:mt-[50]">
            <ul className="flex font-satoshi gap-[44] text-gray-500 md:ml-[318]">
