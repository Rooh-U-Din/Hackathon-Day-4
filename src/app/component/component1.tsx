...
const Component1 = () => {
  ...
  <div className="absolute w-[342px] h-[135px] mt-[40px] ml-[24px] md:ml-[60px] md:mt-[60px] md:w-[513px] md:h-[187px]">
    ...
    <Link href="/product" passHref>
      <button className="w-[170px] h-[56px] hover:bg-[rgb(59,52,104)] text-white bg-[rgb(78,77,147)] mt-[32px] hidden md:block">
        View Collection
      </button>
    </Link>
  </div>
  ...
  <Image
    ...
    height={400}
    width={400}
    className="hidden md:block absolute md:ml-[760px] md:mt-[0px] w-[520px] h-[584px]"
  />
</div>
    )
}
