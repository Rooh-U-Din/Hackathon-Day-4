...
const ShoppingCom1 = () => {
    return (
        <div className="w-[390] h-[729] bg-[rgba(249,249,249,1)] md:h-[749] xl:w-[1440] md:w-[1200] md:mt-[132] ">
            <div className="absolute md:w-[1200] xl:w-[1440]">
                <h1 className="text-2xl ml-6 mt-9 md:ml-[188] font-clash">Your shopping cart</h1>
                
                <div className="flex">
                <span className="sm:hidden md:block md:ml-[188] font-satoshi">Product</span>
                <span className="sm:hidden md:block md:ml-[650] font-satoshi ">Quantity</span>
                <span className="sm:hidden md:block md:ml-[374] font-satoshi ">Total</span>
            </div>
            <Image src="/photos/Divider.png" alt="div" height={100} width={100} className=" sm:hidden md:block h-px w-[1172] ml-[188]"></Image>
            </div>
            <div className="absolute flex gap-[22]">
                ...
                <div className="w-[179] h-[166]">
                    ...
                    <span className="font-satoshi mt-[10px] md:ml-[985] md:mt-[-85] md:absolute">£85</span>
                    <span className="sm:hidden md:block font-satoshi mt-[10px]">£85</span>
                    <div className="flex mt-[16] gap-[20] ml-[20] md:ml-[550] md:mt-[-95]">
            ...
            <div className="absolute flex gap-[22] mt-[204]">
                ...
                <div className="w-[179] h-[166]">
                    ...
                    <span className="font-satoshimt-[10px] md:ml-[985] md:mt-[-85] md:absolute">£125</span>
                    <span className="sm:hidden md:block font-satoshi mt-[10px]">£85</span>
                    <div className="flex mt-[16] gap-[20] ml-[20] md:ml-[550] md:mt-[-95]">
                        <span className="text-gray-200">-</span>
                        <span className="font-satoshi">1</span>
            ...
            <div className="absolute ml-[84] mt-[520] md:ml-[1073]">
                <div className="flex ">
            ...
            <button className="font-satoshi bg-[rgb(42,37,75)] w-[342] h-[56] mt-[590] ml-[24] text-white md:ml-[1190] md:h-[56] md:w-[172]">Go to checkout</button>
        </div>
