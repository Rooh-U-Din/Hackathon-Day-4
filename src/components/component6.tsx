...
const Component6 = () => {
    return (
        <div className="max-w-[390] h-[828] md:flex md:mt-[612] md:max-w-[1440] md:h-[603]">
            ...
            <br />
            <div className="ml-[24] text-gray-500 text-sm md:mt-[-93] font-satoshi">When we started Avion,the idea was simple.Make high <br className="md:hidden" /> quality furniture <br className="sm:hidden md:block" /> affordable and available for the mass <br className="md:hidden"/> market. <br className="sm:hidden md:block"/><br className="sm:hidden md:block"/> <br></br> 
           <br className="md:hidden"></br><br className="md:hidden font-satoshi" /> Handmade, and lovingly crafted furniture and <br className="md:hidden" /> homeware is what we live,<br className="sm:hidden md:block"/> breathe and design so our <br className="md:hidden"/> Chelsea boutique become the hotbed for the <br className="sm:hidden md:block"/> London <br className="md:hidden" /> interior design community.
            </div>
            </div>
            <br />
            <br />
